...
<body>
       ...
       <div class="main_content">
            ...
            <button class="add-btn"><a href="addblocklist.php">  Blog_List <i class="fa-solid fa-plus"></i></a></button></h1>
            <!-- <button class="logout-btn"><a href="main.php"><i class="fa-solid fa-right-from-bracket"></i></a></button> -->
                   <table class="center">
                       ...
                       <tr>
                           ...
                           ?>
                               ...
                               <td> <a href="editblocklist.php?id=<?php echo $row['id'] ?>" class=""><i class="fa-solid fa-pen-to-square"></i></a></td>
                               <td>
                ...
                if (mysqli_num_rows($result1) > 0) {
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        ...
                        echo '<a class="' . $active . '" href="blocklist.php?page=' . $i . '">' . $i . '</a>';
                    }
                    echo '</div>';
                }
                ?>
